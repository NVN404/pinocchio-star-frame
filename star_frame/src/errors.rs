...
pub enum ErrorCode {
    ...
    #[msg("Invalid instruction discriminant provided.")]
    InvalidDiscriminant,

    #[msg("An invalid argument was provided.")]
    InvalidArgument,

    #[msg("Instruction set is empty.")]
    NoInstructionsInSet,

    #[msg("Failed to read instruction discriminant bytes.")]
    ReadDiscriminantFailed,

    #[msg("Failed to cast bytes to discriminant type.")]
    DiscriminantCastFailed,
}
